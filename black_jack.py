...
def calculate_score(cards):
    #Hint7:Inside calculate_score() check for a blackjack (a hand with only 2 cards: ace + 10) 
...
def play_blackjack():
    ...
    while not is_game_over:
        ...
        # If the computer or the user has a blackjack (0) or 
        ...
        if user_score == 0 or computer_score == 0 or user_score > 21:
            ...
            # If yes, then use the deal_card() function 
            # to add another card to the user_cards List. 
